...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (error) {
      ...
      router.push(postLoginRedirect[from] ?? "/")
    }
  }
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input id="password" name="password" type="password" placeholder="Your password" required className="bg-background text-foreground" />
              </div>
